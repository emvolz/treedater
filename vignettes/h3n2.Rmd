...
vignette: >
  %\VignetteIndexEntry{Molecular clock dating of Influenza H3N2}
...
```{r}
tre2 <- ape::drop.tip( tre, rownames(outliers[outliers$q < .9,]) )
```
...
```{r}
rct <- relaxedClockTest( tre2, sts, seqlen, ncpu = 40 ) #TODO
```
...
```{r}
# TODO bug here, calling wrong names 
